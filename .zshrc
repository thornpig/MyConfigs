...
PROMPT='
%{$FG[015]%}[%D{%f/%m/%y} %D{%L:%M:%S}] $(_user_host)${_current_dir} $(git_prompt_info) $(ruby_prompt_info)
...
export PATH=".:$HOME/www/scripts/bin:$PATH"
...
# rust tooling
export PATH="$HOME/.cargo/bin:$HOME/fbsource/fbcode/common/rust/tools/rust-project:$HOME/fbsource/third-party/rust/tools:$HOME/fbsource/tools/third-party/rustfmt:$PATH"
